...
Now supports CentOS as well!

= REQUIREMENTS:

Debian or Ubuntu preferred.  Tested on Ubuntu 8.04 Server LTS, should work on others.

Tested for CentOS 5.6 x86_64, but should work universally across Fedora, RedHat
...
* mongodb[:version] = MongoDB version to install. Default: '1.8.2'
...
* Optional firewall file "port_mongodb.erb" will use the :port attribute for the 'iptables' cookbook.
